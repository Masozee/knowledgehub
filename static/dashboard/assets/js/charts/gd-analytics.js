...
!function (NioApp, $) {
    ...
    if ($(elm).exists() && typeof $.fn.vectorMap === 'function') {
      $(elm).each(function () {
        ...
        $self.vectorMap({
          ...
          scaleColors: ['#ccd7e2', '#309ea0'],
          selectedColor: '#1B5354',
          showTooltip: true,
  ...
  var deviceStatusData = {
    ...
    datasets: [{
      borderColor: "#fff",
      background: ["#1B5354", "#b8acff", "#7de1f8"],
      data: [84.5, 14.2, 1.3]
    }]
  };
  var TrafficChannelDoughnutData = {
    ...
    datasets: [{
      borderColor: "#fff",
      background: ["#1B5354", "#b8acff", "#ffa9ce", "#f9db7b"],
  ...
  var OrganicSearchData = {
    ...
    datasets: [{
      ...
      color: "#1B5354",
      background: NioApp.hexRGB('#1B5354', .25),
  ...
  var analyticOvData = {
    ...
    datasets: [{
      ...
      color: "#1B5354",
      dash: [0, 0],
      background: NioApp.hexRGB('#1B5354', .15),
